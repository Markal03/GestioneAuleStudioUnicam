...
const AulaStudioSchema = new Schema({
    name: { type: String, required: [true, 'Inserisci nome aula studio']},
...
AulaStudioSchema.path('capacity').validate((capacity) => {
    return capacity > 0 && capacity < 999;
});

module.exports = mongoose.model('Aula Studio', AulaStudioSchema);